...
namespace Leap.Unity.DetectionExamples
{
    ...
    public class pinch_emjalbert : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.LogWarning("No pinch detectors were specified!  pinch_emjalbert can not draw any lines without PinchDetectors.");
            }
        }
        ...
        private class DrawState
        {
            ...
            private pinch_emjalbert _parent;
            ...
            public DrawState(pinch_emjalbert parent)
            {
                _parent = parent;
